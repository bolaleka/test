...
var introspection_1 = __importDefault(require("./introspection"));
...
var defaultOptions = {
    resolveIntrospection: introspection_1.default,
    introspection: {
        operationNames: (_a = {},
            _a[ra_core_1.GET_LIST] = function (resource) { return "all" + pluralize_1.default(resource.name); },
            _a[ra_core_1.GET_ONE] = function (resource) { return "" + resource.name; },
            _a[ra_core_1.GET_MANY] = function (resource) { return "all" + pluralize_1.default(resource.name); },
            _a[ra_core_1.GET_MANY_REFERENCE] = function (resource) { return "all" + pluralize_1.default(resource.name); },
...
exports.default = (function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = merge_1.default({}, defaultOptions, options), clientObject = _a.client, clientOptions = _a.clientOptions, introspection = _a.introspection, resolveIntrospection = _a.resolveIntrospection, buildQueryFactory = _a.buildQuery, _b = _a.override, override = _b === void 0 ? {} : _b, otherOptions = __rest(_a, ["client", "clientOptions", "introspection", "resolveIntrospection", "buildQuery", "override"]);
                ...
                client = clientObject || buildApolloClient_1.default(clientOptions);
            ...
            case 2:
                ...
                raDataProvider = function (aorFetchType, resource, params) {
                    var overriddenBuildQuery = get_1.default(override, resource + "." + aorFetchType);
                    try {
